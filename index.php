...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: <?php echo t('font'); ?>; }
        ...
        /* Changed Hero Image to a corporate meeting room */
        ...
        @media(max-width: 768px) { .nav-links { display: none; } .hero h1 { font-size: 32px; } }
    </style>
</head>
<body>
<div class="top-bar">
    ...
    <nav>
        <div class="nav-container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="#services"><?php echo t('eservices'); ?></a></li>
                
                <?php 
                // UI PROTECTION: Only show 'Meeting Schedules' link to Admins & Moderators
                ...
                <?php if (isset($_SESSION['username'])): ?>
                    <li><a href="dashboard.php" class="btn-login"><?php echo t('view_schedule'); ?></a></li>
                <?php else: ?>
                    <li><a href="login.php" class="btn-login"><?php echo t('login'); ?></a></li>
                <?php endif; ?>
            </ul>
        </div>
    </nav>
    ...
    <div class="emergency">
        <i class="fa-solid fa-headset" style="margin: 0 10px;"></i> <?php echo t('emergency'); ?>
    </div>
    ...
    <header class="hero">
        ...
        <div class="hero-btns">
            <a href="login.php" class="btn btn-primary"><i class="fa-solid fa-calendar-check" style="margin: 0 5px;"></i> <?php echo t('view_schedule'); ?></a>
            <a href="#services" class="btn btn-outline"><?php echo t('explore_services'); ?></a>
        </div>
    </header>
    ...
    <section id="services" class="services">
        ...
        <div class="grid">
            ...
            <div class="card">
                ...
                <h3><?php echo t('it_support'); ?></h3>
                <p><?php echo t('it_support_desc'); ?></p>
            </div>
            <div class="card">
    ...
    <script>
        function updateClock() {
            const now = new Date();
            // Automatically detect if page is RTL (Arabic) or LTR (English)
            const lang = document.documentElement.lang === 'ar' ? 'ar-KW' : 'en-US';
            
            // Lock timezone to Kuwait
